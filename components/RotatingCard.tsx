      ...
      >
        ...
        <Card className="absolute inset-0 w-full h-full backface-hidden bg-slate-800 border-slate-700 overflow-hidden group">
          <div className="relative h-full">
            <div className="absolute -inset-4 bg-orange-400 rounded-lg opacity-25 group-hover:opacity-40 transition-opacity duration-300"></div>
            <div className="relative bg-orange-400 rounded-lg p-1 h-full">
              <Image
        ...
        {/* Back Side */}
  <Card className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 bg-slate-800 border-orange-400 overflow-hidden">
          <div className="relative h-full">
