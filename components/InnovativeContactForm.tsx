      ...
      <div className="lg:col-span-1 space-y-6">
        <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border-slate-700 overflow-hidden">
          <CardHeader className="relative">
            <div className="absolute top-0 right-0 w-32 h-32 bg-orange-400/10 rounded-full -translate-y-16 translate-x-16"></div>
            <CardTitle className="text-orange-400 flex items-center gap-2 relative z-10">
        ...
        {/* Quick Stats with Animation */}
            <Card className="bg-gradient-to-r from-orange-600/10 to-blue-600/10 border-orange-400/30">
          <CardHeader>
          ...
          <CardContent className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-slate-700/50 border rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all duration-300 ${
                      focusedField === "name" ? "border-orange-400 bg-slate-700" : "border-slate-600"
                    }`}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocusedField("")}
                    className={`w-full px-4 py-3 bg-slate-700/50 border rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all duration-300 ${
                      focusedField === "email" ? "border-orange-400 bg-slate-700" : "border-slate-600"
                    }`}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onBlur={() => setFocusedField("")}
                    className={`w-full px-4 py-3 bg-slate-700/50 border rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all duration-300 ${
                      focusedField === "company" ? "border-orange-400 bg-slate-700" : "border-slate-600"
                    }`}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
                  >
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onBlur={() => setFocusedField("")}
                    className={`w-full px-4 py-3 bg-slate-700/50 border rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent resize-none transition-all duration-300 ${
                    focusedField === "message" ? "border-orange-400 bg-slate-700" : "border-slate-600"
                  }`}
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-orange-600 to-blue-600 hover:from-orange-700 hover:to-blue-700 text-white font-medium py-4 px-6 rounded-xl transition-all duration-300 disabled:opacity-50 transform hover:scale-105 hover:shadow-lg hover:shadow-orange-400/25"
              >
                {isSubmitting ? (
                  <>
            ...
            <div className="mt-8 pt-6 border-t border-slate-700 text-center">
              <p className="text-sm text-slate-400">
                ...
                <a href="mailto:nivethanraajt@gmail.com" className="text-orange-400 hover:underline font-medium">
                  nivethanraajt@gmail.com
                </a>
              </p>
