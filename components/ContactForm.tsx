          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-3 p-3 bg-slate-700 rounded-lg hover:bg-slate-600 transition-colors">
              ...
              <div>
                ...
                <a href="mailto:nivethanraajt@gmail.com" className="text-slate-400 hover:text-orange-400">
            ...
            <div className="flex items-center gap-3 p-3 bg-slate-700 rounded-lg hover:bg-slate-600 transition-colors">
              ...
              <div>
                ...
                <a href="tel:+917708409636" className="text-slate-400 hover:text-orange-400">
                  +91 7708409636
                </a>
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-slate-700 rounded-lg">
                <div className="text-2xl font-bold text-orange-400">9.09</div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                    className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent resize-none"
            ...
            <Button
              ...
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300 disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="mt-6 pt-6 border-t border-slate-700">
            <p className="text-sm text-slate-400 text-center">
              ...
              <a href="mailto:nivethanraajt@gmail.com" className="text-orange-400 hover:underline">
                nivethanraajt@gmail.com
              </a>
            </p>
          </div>
